package com.nbchen.sssp.controller;

import com.nbchen.sssp.entity.Employee;
import com.nbchen.sssp.service.DepartmentService;
import com.nbchen.sssp.service.EmployeeService;
...
public class EmployeeHandler {
    ...
    public String list(
        ...
        // 用string接收,防止传abc过来导致程序死掉,可以接收过来,再做校验
        int pageNo = 1;
        try {
